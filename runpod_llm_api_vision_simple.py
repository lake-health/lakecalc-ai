#!/usr/bin/env python3
"""
RunPod LLM API with Vision Support and PDF-to-Image Conversion - Simple Clean Version
"""
import os
import json
import logging
...
async def call_llava_vision_pdf(file_path: str) -> Dict[str, Any]:
    ...
    try:
        ...
        # Simple, clean vision prompt
        prompt = """Extract biometry data from this medical document image.
