#!/usr/bin/env python3
"""
RunPod LLM API with Vision Support and PDF-to-Image Conversion - Improved Patient Info Extraction
"""
import os
import json
import logging
...
async def call_llava_vision_pdf(file_path: str) -> Dict[str, Any]:
    ...
    try:
        ...
        # Create improved vision prompt for biometry parsing
...
3. Age is often near patient name or in demographic information
