#!/usr/bin/env python3
"""
RunPod LLM API with Vision Support - Debug Version to see what LLaVA is reading
"""
import os
import json
import logging
...
async def call_llava_vision_pdf(file_path: str) -> Dict[str, Any]:
    ...
    try:
        ...
        # Debug prompt to see what LLaVA is reading
        prompt = """Look at this medical document image and describe what you see. 

First, tell me:
1. What is the patient's name?
2. What is the patient's age?
3. What biometry measurements do you see?

Then extract the data in JSON format:
{
  "patient_name": "actual name from document",
  "age": actual_age_number,
